...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.preferencesMenuAction.triggered.connect(
        ...
        self.graphicsScene = QGraphicsScene(0, 0, 511, 511, self)
        ...
        nodeGraphicsItem_1 = QGraphicsEllipseItem(rect_1)
        ...
        nodeTextItem_1.setPos(nodeCentre_1.x(
        ) - boundingRect_1.width()/2, nodeCentre_1.y() - boundingRect_1.height() / 2)
        ...
        rect_2 = QRectF(x2 - self.nodeRadius, y2 - self.nodeRadius,
                        2.0 * self.nodeRadius, 2.0 * self.nodeRadius)
        ...
        nodeTextItem_2.setPos(nodeCentre_2.x(
        ) - boundingRect_2.width()/2, nodeCentre_2.y() - boundingRect_2.height() / 2)
        ...
        ctrlX_1 = 50.0
        ctrlY_1 = 150.0
        arc_PainterPath_1.quadTo(
            ctrlX_1, ctrlY_1, nodeCentre_2.x(), nodeCentre_2.y())
        ...
        ctrlX_2 = 150.0
        ctrlY_2 = 150.0
        arc_PainterPath_2.quadTo(
            ctrlX_2, ctrlY_2, nodeCentre_2.x(), nodeCentre_2.y())
