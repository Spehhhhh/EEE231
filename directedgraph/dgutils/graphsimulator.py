...
if __name__ == "__main__":
    ...
    with open("test.cir", "w", newline="", encoding="utf-8") as f:
        ...
        f_csv.writerow(
            [f"VDD", uid_map[sourcenode_list[0].uid], uid_map[groundnode_list[0].uid], sourcenode_list[0].user_defined_attribute])
        ...
        for arc in arc_list:
            if arc.user_defined_arc_type == "Resistor":
                ...
                f_csv.writerow([f"R{resistor_count}", uid_map[arc.nodes[0].uid], uid_map[arc.nodes[1].uid], arc.user_defined_attribute])
            ...
            if arc.user_defined_arc_type == "Capacitor":
                ...
                f_csv.writerow([f"C{resistor_count}", uid_map[arc.nodes[0].uid], uid_map[arc.nodes[1].uid], arc.user_defined_attribute])
