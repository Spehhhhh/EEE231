...
class Window(QMainWindow):
    def __init__(self):
        ...
        self.setGeometry(300,200,500,500) # Main Window 的信息 （x位置，y位置，宽度，长度）   #Some Definition on the Main window
    ...
    def createui(self):
        ...
        scene = QGraphicsScene(self) # QGraphicsScene 相当于一个容器，里面包括全部的图形（颜色，位置，大小这些）QGraphicsScene is like a container which contain all the shape, location,size
