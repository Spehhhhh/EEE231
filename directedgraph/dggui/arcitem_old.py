...
from PySide6.QtGui import QAction, QBrush, QPainter
...
class GraphEditorMainWindow(QMainWindow, QDialog):
    ...
    def contextMenuEvent(self, event):
        ...
        self._extracted_from_contextMenuEvent_5(contextmenu, newaction, "Open")
        # openaction.triggered.connect()

        saveaction = QAction("Save")
        self._extracted_from_contextMenuEvent_13(contextmenu, saveaction, "Copy")
        # copyaction.triggered.connect()

        pastaction = contextmenu.addAction("Past")
        self._extracted_from_contextMenuEvent_5(contextmenu, pastaction, "Help...")

    # TODO Rename this here and in `contextMenuEvent`
    def _extracted_from_contextMenuEvent_13(self, contextmenu, arg1, arg2):
        contextmenu.addAction(arg1)
        # saveaction.triggered.connect()

        copyaction = QAction(arg2)
        contextmenu.addAction(copyaction)

    # TODO Rename this here and in `contextMenuEvent`
    def _extracted_from_contextMenuEvent_5(self, contextmenu, arg1, arg2):
        self._extracted_from_contextMenuEvent_13(contextmenu, arg1, arg2)
        # copyaction.triggered.connect()
